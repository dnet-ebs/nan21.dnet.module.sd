...
Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_Ds", {
...
Dnet.createFilterModelFromRecordModel({
	...
	recordModelFqn: Dnet.ns.sd + "SalesInvoiceLineOverview_Ds"
});

Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_DsParam", {
	extend: 'Ext.data.Model',
