 ...
 */
Ext.define(Dnet.ns.sd + "SalesOrderLine_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.sd + "SalesOrderLine_Ds"
});

/* ================= FILTER: FilterCtx ================= */


Ext.define(Dnet.ns.sd + "SalesOrderLine_Dc$FilterCtx" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterPropGrid",
	alias: "widget.sd_SalesOrderLine_Dc$FilterCtx",
...
Ext.define(Dnet.ns.sd + "SalesOrderLine_Dc$CtxList" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sd_SalesOrderLine_Dc$CtxList",
	_noImport_: true,
	_noExport_: true,
	_noPrint_: true,
...
Ext.define(Dnet.ns.sd + "SalesOrderLine_Dc$EditForm" , {
	extend: "dnet.core.dc.view.AbstractDcvEditForm",
	alias: "widget.sd_SalesOrderLine_Dc$EditForm",
