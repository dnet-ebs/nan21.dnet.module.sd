 ...
 */
Ext.define(Dnet.ns.sd + "SalesInvoiceLineTax_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.sd + "SalesInvoiceLineTax_Ds"
});

/* ================= GRID: CtxList ================= */

Ext.define(Dnet.ns.sd + "SalesInvoiceLineTax_Dc$CtxList" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sd_SalesInvoiceLineTax_Dc$CtxList",
	_noImport_: true,
	_noExport_: true,
	_noPrint_: true,
