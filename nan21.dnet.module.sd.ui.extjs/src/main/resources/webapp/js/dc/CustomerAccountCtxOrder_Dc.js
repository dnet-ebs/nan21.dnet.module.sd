 ...
 */
Ext.define(Dnet.ns.sd + "CustomerAccountCtxOrder_Dc" , {
...
Ext.define(Dnet.ns.sd + "CustomerAccountCtxOrder_Dc$Filter" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterPropGrid",
	alias: "widget.sd_CustomerAccountCtxOrder_Dc$Filter",
...
Ext.define(Dnet.ns.sd + "CustomerAccountCtxOrder_Dc$List" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sd_CustomerAccountCtxOrder_Dc$List",
	_noImport_: true,
