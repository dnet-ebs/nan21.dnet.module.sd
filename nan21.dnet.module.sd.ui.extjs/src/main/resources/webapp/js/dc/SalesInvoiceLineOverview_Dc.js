 ...
 */
Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	filterModel: Dnet.ns.sd + "SalesInvoiceLineOverview_DsFilter",
	paramModel: Dnet.ns.sd + "SalesInvoiceLineOverview_DsParam",
	recordModel: Dnet.ns.sd + "SalesInvoiceLineOverview_Ds"
});

/* ================= FILTER FORM: Filter ================= */			

Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_Dc$Filter" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterForm",
	alias: "widget.sd_SalesInvoiceLineOverview_Dc$Filter",
...
Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_Dc$List" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sd_SalesInvoiceLineOverview_Dc$List",
	_noImport_: true,
...
Ext.define(Dnet.ns.sd + "SalesInvoiceLineOverview_Dc$DocView" , {
	extend: "dnet.core.dc.view.AbstractDcvEditForm",
	alias: "widget.sd_SalesInvoiceLineOverview_Dc$DocView",
