 ...
 */
Ext.define(Dnet.ns.sd + "SalesInvoiceTax_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.sd + "SalesInvoiceTax_Ds"
});

/* ================= GRID: List ================= */

Ext.define(Dnet.ns.sd + "SalesInvoiceTax_Dc$List" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sd_SalesInvoiceTax_Dc$List",
