...
@Ds(entity = SalesOrderLineTax.class)
public class SalesOrderLineTax_Ds
		extends
			AbstractAuditableDs<SalesOrderLineTax> {
	...
	public SalesOrderLineTax_Ds() {
		super();
	}

	public SalesOrderLineTax_Ds(SalesOrderLineTax e) {
		super(e);
	}
