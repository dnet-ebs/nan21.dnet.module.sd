...
public class SalesInvoiceLineOverview_Ds
		extends
			AbstractAuditableDs<SalesInvoiceLine> {
	...
	@DsField(join = "left", path = "invoice.docType.id")
	private String docTypeId;

	@DsField(join = "left", path = "invoice.docType.code")
	private String docType;

	@DsField(join = "left", path = "invoice.currency.id")
	private String currencyId;

	@DsField(join = "left", path = "invoice.currency.code")
	private String currency;

	@DsField(join = "left", path = "invoice.company.id")
	private String companyId;

	@DsField(join = "left", path = "invoice.company.code")
	private String company;

	@DsField(join = "left", path = "invoice.bpAccount.id")
	private String bpAccountId;

	@DsField(join = "left", path = "invoice.bpAccount.bpartner.id")
	private String bpartnerId;

	@DsField(join = "left", path = "invoice.bpAccount.bpartner.code")
	private String bpartner;

	@DsField(join = "left", path = "invoice.bpAccount.bpartner.name")
	...
	public SalesInvoiceLineOverview_Ds() {
		super();
	}

	public SalesInvoiceLineOverview_Ds(SalesInvoiceLine e) {
		super(e);
	}
