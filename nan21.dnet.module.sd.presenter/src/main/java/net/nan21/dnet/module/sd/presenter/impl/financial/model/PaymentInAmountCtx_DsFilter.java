...
import net.nan21.dnet.module.sd.presenter.impl.financial.model.PaymentInAmountCtx_Ds;

/**
 * Helper filter object to run query by example with range values.
 *
 */
public class PaymentInAmountCtx_DsFilter extends PaymentInAmountCtx_Ds {
