...
@RefLookups({
		@RefLookup(refId = SalesOrderLine_Ds.f_orderId, namedQuery = SalesOrder.NQ_FIND_BY_DOCNO, params = {@Param(name = "docNo", field = SalesOrderLine_Ds.f_orderDocNo)}),
		@RefLookup(refId = SalesOrderLine_Ds.f_productAccountId, namedQuery = ProductAccount.NQ_FIND_BY_PROD_ORG_PRIMITIVE, params = {
				@Param(name = "productId", field = SalesOrderLine_Ds.f_productId),
				@Param(name = "companyId", field = SalesOrderLine_Ds.f_companyId)}),
		@RefLookup(refId = SalesOrderLine_Ds.f_uomId, namedQuery = Uom.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = SalesOrderLine_Ds.f_uom)}),
		@RefLookup(refId = SalesOrderLine_Ds.f_taxId, namedQuery = Tax.NQ_FIND_BY_NAME, params = {@Param(name = "name", field = SalesOrderLine_Ds.f_tax)})})
public class SalesOrderLine_Ds extends AbstractAuditableDs<SalesOrderLine> {
	...
	public SalesOrderLine_Ds() {
		super();
	}

	public SalesOrderLine_Ds(SalesOrderLine e) {
		super(e);
	}
