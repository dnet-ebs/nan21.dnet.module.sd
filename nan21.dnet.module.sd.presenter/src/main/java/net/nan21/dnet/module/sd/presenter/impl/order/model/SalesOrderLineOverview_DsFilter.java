...
import net.nan21.dnet.module.sd.presenter.impl.order.model.SalesOrderLineOverview_Ds;

/**
 * Helper filter object to run query by example with range values.
 *
 */
public class SalesOrderLineOverview_DsFilter extends SalesOrderLineOverview_Ds {
